...
@Component({
  selector: 'app-worst-stages-customers',
  templateUrl: './worst-stages-customers.component.html',
  styleUrls: ['./worst-stages-customers.component.scss']
})
export class WorstStagesCustomersComponent {
  formWorstStages: FormGroup;
  ...
  constructor(
    ...
    this.formWorstStages = this.formBuilder.group({
  ...
  getHistorical(){
    if (this.formWorstStages.valid) {
      this.historicalService.listHistorical(this.formWorstStages.value).subscribe(response => {
