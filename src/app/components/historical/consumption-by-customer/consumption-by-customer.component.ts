...
@Component({
  selector: 'app-consumption-by-customer',
  templateUrl: './consumption-by-customer.component.html',
  styleUrls: ['./consumption-by-customer.component.scss']
})
export class ConsumptionByCustomerComponent {
  ...
  getHistorical(){
    if (this.formCustomer.valid) {
      this.historicalService.listHistorical(this.formCustomer.value).subscribe(response => {
